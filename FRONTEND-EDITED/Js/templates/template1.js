...
function updatePreviewElement(previewId, value) {
  ...
  if (previewId === "preview-linkedin") {
    if (value.trim()) {
      previewElement.innerHTML = `<a href="${value}" target="_blank">LinkedIn</a>`;
    } else {
      previewElement.innerHTML = "Your LinkedIn profile will appear here...";
    }
  } else {
